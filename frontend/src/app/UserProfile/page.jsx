                ...
                <Box display="flex" alignItems="center" mb={3}>
                  <Avatar 
                    sx={{ 
                      ...
                      height: 100, 
                      mr: 3, 
                      bgcolor: profile?.role === 'DRIVER' ? 'primary.main' : 'secondary.main' 
                    }}
                  >
                  ...
                  <Box>
                    ...
                    <Chip 
                      label={profile?.role}
                      color={profile?.role === 'DRIVER' ? 'primary' : 'secondary'}
                      sx={{ mt: 1 }}
                    />
                  </Box>
                </Box>
                  ...
                  <Box>
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} sm={6}>
                        ...
                        <Typography variant="body1">
                          {profile?._count?.bookings || 0} bookings as passenger
                          {profile?.role === 'DRIVER' && `${profile?._count?.ridesGiven || 0} rides as driver`}
                        </Typography>
                      </Grid>
                      <Grid item xs={12}>
                        <Box display="flex" justifyContent="flex-end" mt={2}>
          ...
          <TabPanel value={tabValue} index={2}>
            <Card>
              <CardContent>
                ...
                <Box sx={{ py: 2 }}>
                  <Alert severity="info">
                    View your ride history in the Dashboard under "Completed Rides" tab.
                  </Alert>
                  <Button 
                    variant="contained" 
                    color="primary" 
