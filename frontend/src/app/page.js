            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  <span className="block">Your journey begins</span>
                  <span className="block text-blue-600">with a single tap</span>
                </h1>
          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">Fast Pickup</h3>
              ...
              <div className="flex flex-col items-center">
                ...
                <h3 className="mt-4 text-lg font-medium text-gray-900">Affordable Rates</h3>
                <p className="mt-2 text-base text-gray-500">
